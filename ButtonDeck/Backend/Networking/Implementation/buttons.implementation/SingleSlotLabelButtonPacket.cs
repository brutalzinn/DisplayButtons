...
namespace ButtonDeck.Backend.Networking.Implementation
{
    ...
    public class SingleSlotLabelButtonChangePacket : INetworkPacket
    {
        public SingleSlotLabelButtonChangePacket()
        { }
        public SingleSlotLabelButtonChangePacket(DeckImage deckImage)
        {
            DeckImage = deckImage;
        }
        ...
        {
            return new SingleSlotLabelButtonChangePacket();
        }
